...
var jade_indent = [];
buf.push("\n<div gantt=\"gantt\" headers=\"['month', 'day']\" time-frames=\"options.timeFrames\" date-frames=\"options.dateFrames\" time-frames-non-working-mode=\"&quot;cropped&quot;\" data=\"data\" api=\"registerApi\" options=\"options\" currentDate=\"options.currentDate\" column-width=\"options.columnWidth\" max-height=\"maxHeight()\" from-date=\"options.fromDate\" to-date=\"options.toDate\">\n  <gantt-tree></gantt-tree>\n  <gantt-tooltips template-url=\"views/tooltips.tmpl.html\"></gantt-tooltips>\n  <gantt-groups template-url=\"views/taskgroup.tmpl.html\"></gantt-groups>\n  <gantt-progress></gantt-progress>\n  <gantt-dependencies js-plumb-defaults=\"{ Connector: [ &quot;Flowchart&quot;, { stub: 10 } ], ConnectionsDetachable: false, ConnectionOverlays: [[&quot;Arrow&quot;, { location:1, length: 7, width: 7 }]], PaintStyle: { lineWidth: 0.8, strokeStyle:&quot;#000&quot; } }\" endpoints=\"[ { anchor: [ 0.8, 1, 0, 1 ], isSource: true, enabled: false, endpoint: &quot;Blank&quot;, maxConnections: 100 }, { anchor: &quot;Left&quot;, isTarget: true, enabled: false, endpoint: &quot;Blank&quot;, maxConnections: 100 } ]\"></gantt-dependencies>\n</div>");;return buf.join("");
};
if (typeof define === 'function' && define.amd) {
  define([], function() {
    return __templateData;
