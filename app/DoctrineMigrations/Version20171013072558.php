 ...
 */
class Version20171013072558 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE crm__project (id INT NOT NULL, parent_id INT DEFAULT NULL, client_id INT DEFAULT NULL, fileset_id INT DEFAULT NULL, object_identity_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, status VARCHAR(16) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, deleted_at DATETIME DEFAULT NULL, lft INT NOT NULL, rgt INT NOT NULL, root INT DEFAULT NULL, lvl INT NOT NULL, INDEX IDX_357C7C38727ACA70 (parent_id), INDEX IDX_357C7C3819EB6921 (client_id), INDEX IDX_357C7C38304051B3 (fileset_id), INDEX IDX_357C7C383D9AB4A6 (object_identity_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
