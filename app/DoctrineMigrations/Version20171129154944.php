 ...
 */
class Version20171129154944 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE crm__client (id INT AUTO_INCREMENT NOT NULL, fileset_id INT DEFAULT NULL, object_identity_id INT DEFAULT NULL, owner_id INT DEFAULT NULL, project_manager_id INT DEFAULT NULL, financial_information VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, deleted_at DATETIME DEFAULT NULL, referral VARCHAR(255) DEFAULT NULL, type VARCHAR(255) NOT NULL, status VARCHAR(16) DEFAULT NULL, company_name VARCHAR(255) DEFAULT NULL, company_sector_of_activity VARCHAR(255) DEFAULT NULL, company_country VARCHAR(8) DEFAULT NULL, company_website VARCHAR(255) DEFAULT NULL, company_email VARCHAR(255) DEFAULT NULL, company_phone1 VARCHAR(255) DEFAULT NULL, company_phone2 VARCHAR(255) DEFAULT NULL, company_fax VARCHAR(255) DEFAULT NULL, INDEX IDX_D23CAF41304051B3 (fileset_id), INDEX IDX_D23CAF413D9AB4A6 (object_identity_id), INDEX IDX_D23CAF417E3C61F9 (owner_id), INDEX IDX_D23CAF4160984F51 (project_manager_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE crm__project (id INT AUTO_INCREMENT NOT NULL, parent_id INT DEFAULT NULL, client_id INT DEFAULT NULL, fileset_id INT DEFAULT NULL, object_identity_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, status VARCHAR(16) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, deleted_at DATETIME DEFAULT NULL, lft INT NOT NULL, rgt INT NOT NULL, root INT DEFAULT NULL, lvl INT NOT NULL, INDEX IDX_357C7C38727ACA70 (parent_id), INDEX IDX_357C7C3819EB6921 (client_id), INDEX IDX_357C7C38304051B3 (fileset_id), INDEX IDX_357C7C383D9AB4A6 (object_identity_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE media__media (id INT AUTO_INCREMENT NOT NULL, category_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, description TEXT DEFAULT NULL, enabled TINYINT(1) NOT NULL, provider_name VARCHAR(255) NOT NULL, provider_status INT NOT NULL, provider_reference VARCHAR(255) NOT NULL, provider_metadata LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:json)\', width INT DEFAULT NULL, height INT DEFAULT NULL, length NUMERIC(10, 0) DEFAULT NULL, content_type VARCHAR(255) DEFAULT NULL, content_size INT DEFAULT NULL, copyright VARCHAR(255) DEFAULT NULL, author_name VARCHAR(255) DEFAULT NULL, context VARCHAR(64) DEFAULT NULL, cdn_is_flushable TINYINT(1) DEFAULT NULL, cdn_flush_identifier VARCHAR(64) DEFAULT NULL, cdn_flush_at DATETIME DEFAULT NULL, cdn_status INT DEFAULT NULL, updated_at DATETIME NOT NULL, created_at DATETIME NOT NULL, file_category VARCHAR(50) DEFAULT NULL, INDEX IDX_5C6DD74E12469DE2 (category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE classification__category (id INT AUTO_INCREMENT NOT NULL, context_id VARCHAR(255) DEFAULT NULL, parent_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, enabled TINYINT(1) NOT NULL, slug VARCHAR(255) NOT NULL, description VARCHAR(255) DEFAULT NULL, position INT DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX IDX_43629B366B00C1CF (context_id), INDEX IDX_43629B36727ACA70 (parent_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE crm__project ADD CONSTRAINT FK_357C7C38727ACA70 FOREIGN KEY (parent_id) REFERENCES crm__project (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE crm__project DROP FOREIGN KEY FK_357C7C38727ACA70');
